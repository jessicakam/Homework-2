...
contract TestBettingContract {
	...
	function testChooseOracle() {
		address oracle = betting.chooseOracle(0x0014723a09acff6d2a60dcdf7aa4aff308fddc160c); //00
	...
	function testMakeBet() {
		address exampleA = 0x004b0897b0513fdc7c541b6d9d7e929c4e5364d2db; //00
		// betting.getCurrAddress.call({from:exampleA});
		////bool boolA = betting.makeBet(1, {value: 50});
		bool boolA = betting.makeBet({_outcome: 50});
